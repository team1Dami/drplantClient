...
public class Plague implements Serializable {
    ...
    /* public Plague (){
        this.scienceName = new SimpleStringProperty();
     ...
     * @param photo
     */
    public Plague(String scienceName, String commonName,
            String description, String control,
            String remedy, PlagueType type, byte[] photo, Set<Plant> plants) {
